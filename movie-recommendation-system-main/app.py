...
def fetch_poster(movie_id):
    url = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=fcb99772a46d2d8736dd96a33fd31434&language=en-US"
    try:
...
# Streamlit UI
# st.title('Movie Recommender System')
st.markdown("<h1 style='text-align: center; color: #ffffbb;'>Movie Recommender System</h1>", unsafe_allow_html=True)
